...
const CTA = () => {
  return (
    ...
    <Link href="/contact" className="relative w-[220px] h-[55px] rounded-lg border-[1px] border-slate-50 overflow-hidden group z-10 mt-6" aria-label="links to contact page">
          <Button className="absolute top-0 h-full w-full flex justify-center items-center font-semibold tracking-wide bg-transparent"><p className="z-10 group-hover:text-black duration-700 transition-all text-sm tracking-widest">GET A FREE REDESIGN</p></Button>
