        ...
        <div className="mt-4 flex justify-center items-center gap-2">
          ...
          >
            <Button className="absolute top-0 h-full w-full flex justify-center items-center font-semibold tracking-wide bg-transparent">
              <p className="z-10 group-hover:text-black duration-700 transition-all text-sm tracking-widest">
                VIEW PRICING
              </p>
            </Button>
          ...
          <Link href="/contact">
            <Button className="w-[210px] h-[50px] bg-slate-50 text-slate-950 text-sm tracking-widest">
              GET A FREE REDESIGN
            </Button>
          </Link>
        </div>
