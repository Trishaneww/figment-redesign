  ...
  return (
    <div className="flex flex-col gap-2 items-center justify-center text-[#F5EADF] z-30 bg-[#1A1A1A]">
      <div className="flex flex-col items-center lg:w-[60%] text-center text-base gap-4 mt-44 px-6 max-w-[900px]">
        ...
        <p className="px-6 text-xl lg:w-[70%] xl:min-w-[700px]">We design and develop custom, high-performing websites tailored to help your business stand out and grow.</p>
        <div className="mt-4 flex justify-center items-center gap-2">
        <Link href="/pricing" className="relative w-[150px] h-[50px] rounded-lg border-[1px] border-slate-50 overflow-hidden group z-10">
          <Button className="absolute top-0 h-full w-full flex justify-center items-center font-semibold tracking-wide bg-transparent"><p className="z-10 group-hover:text-black duration-700 transition-all text-lg">View Pricing</p></Button>
