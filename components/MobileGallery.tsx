...
const images = [
  [
    ...
    { src: "/assets/images/proj13.png", speed: 0.1 },
    { src: "/assets/images/hero4.png", speed: 0.1 },
    { src: "/assets/images/proj26.png", speed: 0.1 },
    { src: "/assets/images/proj14.png", speed: 0.1 },
    { src: "/assets/images/proj8.png", speed: 0.1 },
    { src: "/assets/images/proj11.png", speed: 0.1 },
    { src: "/assets/images/hero3.png", speed: 0.5 },
    { src: "/assets/images/hero2.png", speed: 0.1 },
    { src: "/assets/images/proj5.png", speed: 0.1 },
  ],
  [
    ...
    { src: "/assets/images/proj28.png", speed: 0.05 },
    ...
    { src: "/assets/images/proj27.png", speed: 0.1 },
    { src: "/assets/images/hero3.png", speed: 0.5 },
    ...
    <div className="relative w-full overflow-hidden h-[200vh] bg-[#1A1A1A]">
      <div className="gap-2 flex justify-center px-2">
        {images.map((column, colIndex) => (
          <div key={colIndex} className={`flex flex-col gap-2 will-change-transform ${colIndex % 2 === 0 ? `-mt-[1100px]` : '-mt-[3000px]'}`} ref={(el) => { imageRefs.current[colIndex][0] = el; }}>
