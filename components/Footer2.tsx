                ...
                <div className="flex gap-4">
                    ...
                    <div className="flex flex-col">
                        <ul className="text-slate-50 text-base flex flex-col gap-2">
                            ...
                            <li><Link href="/https://www.instagram.com/stephenson.media/" target="_blank" aria-label="View more of our work on instagram">TikTok</Link></li>
                        </ul>
                    </div>
                </div>
                ...
                <div className="flex gap-4">
                    ...
                    <div className="flex flex-col">
                        <ul className="text-slate-50 text-base flex flex-col gap-2">
                            ...
                            <li><Link href="/#services">Videography</Link></li>
                            <li><Link href="/#services">Premium content creation</Link></li>
